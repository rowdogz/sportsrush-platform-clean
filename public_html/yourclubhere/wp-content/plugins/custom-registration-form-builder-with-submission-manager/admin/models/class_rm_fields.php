...
class RM_Fields extends RM_Base_Model
{
    ...
    public function __construct()
    {
        ...
        $this->valid_options = array('field_is_multiline','field_is_admin_only','field_placeholder', 'field_timezone', 'field_select_label', 'field_enable_search', 'field_max_length', 'field_min_length', 'field_is_required_range', 'field_is_required_max_range', 'field_is_required_min_range', 'field_is_required_scroll', 'field_check_above_tc', 'field_default_value', 'field_css_class', 'field_textarea_columns', 'field_textarea_rows', 'field_is_required','field_is_show_asterix', /*'field_is_required_scroll',*/'field_is_read_only', 'field_is_other_option', 'rm_textbox', 'help_text', 'icon','field_validation','custom_validation', 'tnc_cb_label', 'date_format','field_is_unique','un_err_msg', 'rating_conf','conditions','field_meta_add','conditions','link_same_window','link_page','link_href','link_type','yt_auto_play','yt_repeat','yt_related_videos','yt_player_width','rm_widget','yt_player_height','if_width','if_height',
    ...
    public function set_gender_options($gender_options)
    {
        $this->field_options->gender_options = maybe_serialize($gender_options);
    }
