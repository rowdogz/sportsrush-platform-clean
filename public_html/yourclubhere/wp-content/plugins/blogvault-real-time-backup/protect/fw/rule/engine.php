...
if (!class_exists('BVProtectFWRuleEngine_V636')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V636 {
	use BVProtectFWRuleStringFunc_V636;
	use BVProtectFWRuleArrayFunc_V636;
	use BVProtectFWRuleMiscFunc_V636;
	use BVProtectFWRuleRequestFunc_V636;
	use BVProtectFWRuleWPFunc_V636;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V636::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V636 $e) {
			$this->error = $e;
		}
	}
