...
function sportsrush_filter_results() {
    ...
    if ($query->have_posts()) {
        while ($query->have_posts()) {
            ...
            echo '<p>' . esc_html(get_post_meta(get_the_ID(), 'result', true)) . '</p>';
            echo '</div>';
        }
    } else {
...
add_action('wp_ajax_filter_results', 'sportsrush_filter_results');
add_action('wp_ajax_nopriv_filter_results', 'sportsrush_filter_results');

// Results page shortcode
function sportsrush_results_page_shortcode() {
    ob_start();
    ?>
...
add_shortcode('sportsrush_results_page', 'sportsrush_results_page_shortcode');
