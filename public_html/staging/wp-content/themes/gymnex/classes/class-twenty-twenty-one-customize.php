		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'Gymnex' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'Gymnex' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'Gymnex' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'Gymnex' ),
						'full'    => esc_html__( 'Full text', 'Gymnex' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new Twenty_Twenty_One_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'Gymnex' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
