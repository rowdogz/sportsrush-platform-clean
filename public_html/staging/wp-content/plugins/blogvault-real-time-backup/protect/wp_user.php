...
if (!class_exists('BVProtectWPUser_V581')) :
class BVProtectWPUser_V581 {
	public $id;
	public $role;
	public $role_level;
	public $capabilities;
	...
	public static function defaultUser() {
		...
		return (new BVProtectWPUser_V581(0, 0, array(), $time));
	}
	...
	public static function _unserialize($serialized_user) {
		...
		return (new BVProtectWPUser_V581((int) $id, (int) $role_level, $capabilities, (int) $time));
	}
