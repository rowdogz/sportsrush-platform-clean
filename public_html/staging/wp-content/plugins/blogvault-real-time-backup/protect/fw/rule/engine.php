...
if (!class_exists('BVProtectFWRuleEngine_V581')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V581 {
	use BVProtectFWRuleStringFunc_V581;
	use BVProtectFWRuleArrayFunc_V581;
	use BVProtectFWRuleMiscFunc_V581;
	use BVProtectFWRuleRequestFunc_V581;
	use BVProtectFWRuleWPFunc_V581;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V581::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V581 $e) {
			$this->error = $e;
		}
	}
