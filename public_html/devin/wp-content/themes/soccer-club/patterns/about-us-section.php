 ...
 * About Us Section
 * 
 * slug: soccer-club/about-us-section
 * title: About Us Section
 * categories: soccer-club
 */

    return array(
        'title'      =>__( 'About Us Section', 'soccer-club' ),
        ...
        <div class="wp-block-column about-us-col02 wow bounceInUp center"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|accent"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"accent","fontSize":"large","fontFamily":"teko"} -->
        <p class="has-background-color has-text-color has-link-color has-teko-font-family has-medium-font-size" style="font-style:normal;font-weight:600">'. esc_html__('About Us','soccer-club').'</p>
        <!-- /wp:paragraph -->

        <!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"800","fontSize":"34px","textTransform":"capitalize"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"textColor":"background","fontFamily":"teko"} -->
         <h2 class="wp-block-heading has-background-color has-text-color has-link-color has-teko-font-family" style="font-size:34px;font-style:normal;font-weight:800;text-transform:capitalize">'. esc_html__('We want to give you the best services','soccer-club').'</h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.8"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"textColor":"background","fontSize":"upper-heading","fontFamily":"abel"} -->
        <p class="has-background-color has-text-color has-link-color has-abel-font-family has-upper-heading-font-size" style="line-height:1.8">'. esc_html__('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s','soccer-club').'</p>
        <!-- /wp:paragraph -->
        ...
        <!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"19px","textTransform":"capitalize"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"textColor":"background","fontFamily":"teko"} -->
         <h2 class="wp-block-heading has-background-color has-text-color has-link-color has-teko-font-family" style="margin-top:var(--wp--preset--spacing--40);font-size:19px;font-style:normal;font-weight:700;text-transform:capitalize">'. esc_html__('Guaranteed Results','soccer-club').'</h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.8"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}}},"textColor":"background","fontSize":"upper-heading","fontFamily":"abel"} -->
        <p class="has-background-color has-text-color has-link-color has-abel-font-family has-upper-heading-font-size" style="line-height:1.8">'. esc_html__('Lorem Ipsum is simply dummy text of the printing and typesetting industry.','soccer-club').'</p>
        <!-- /wp:paragraph --></div>
        <!-- /wp:column -->
        ...
        <!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"19px","textTransform":"capitalize"},"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"textColor":"background","fontFamily":"teko"} -->
         <h2 class="wp-block-heading has-background-color has-text-color has-link-color has-teko-font-family" style="margin-top:var(--wp--preset--spacing--40);font-size:19px;font-style:normal;font-weight:700;text-transform:capitalize">'. esc_html__('Quality Services','soccer-club').'</h2>
        <!-- /wp:heading -->
