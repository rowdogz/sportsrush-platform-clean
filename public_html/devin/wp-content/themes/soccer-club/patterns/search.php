 ...
 * Search Section
 * 
 * slug: soccer-club/search
 * title: Search
 * categories: soccer-club
 */

return array(
    'title'      =>__( 'Search', 'soccer-club' ),
...
<h2 class="wp-block-heading has-text-align-center">'. esc_html__(' No results found','soccer-club') .'</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"> '. esc_html__('  We could not find any posts matching your search. Try different keywords.','soccer-club') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
