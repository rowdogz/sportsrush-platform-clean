...
<main class="wp-block-group alignfull"><!-- wp:columns {"verticalAlignment":"center","align":"full","className":"slider-banner wow zoomIn"} -->
<div class="wp-block-columns alignfull are-vertically-aligned-center slider-banner wow zoomIn"><!-- wp:column {"width":"30%"} -->
...
<!-- wp:navigation-link {"label":"Get Pro","url":"https://www.wpradiant.net/products/soccer-club-wordpress-theme","kind":"custom","className":"getpro","opensInNewTab":true} /-->
<!-- /wp:navigation --></div>
<!-- /wp:column -->
