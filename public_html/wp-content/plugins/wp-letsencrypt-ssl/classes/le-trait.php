...
class WPLE_Trait {
    ...
    public static function ssl_expired_email( $expiry_date ) {
        ...
        if ( $current_timestamp >= $expiry_timestamp && $current_timestamp <= $expired_past3days ) {
            ...
            $body .= '<ol>';
            $body .= '<li>Upgrade and activate PRO version via <a href="' . admin_url( '/admin.php?page=wp_encryption-pricing' ) . '">Upgrade Page</a> (Clicking on <b>Advanced > Proceed to insecure site</b> option shown on your browser)</li>';
