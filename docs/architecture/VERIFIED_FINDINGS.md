...
_Document generated: May 2026. All evidence taken from committed repository files only. Live database state, server cron schedules, and runtime WooCommerce gateway configuration are outside the scope of this verification._
