...
_This document is the target state. It does not describe the migration path in full implementation detail — that is a phase-by-phase project plan built once Owner Decisions are resolved and the team is assembled._
