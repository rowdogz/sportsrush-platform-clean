...
_Evidence base: `VERIFIED_FINDINGS.md` (claim-by-claim verification against this repository). All file and line references are from committed code, not inferred._
