...
*Domain model version 1.0. All Owner Decisions from `SPORTSRUSH_CANONICAL_RULES.md` must be resolved before implementation begins. Domains with unresolved Owner Decisions: Scoring Engine (OD-01, OD-02), Rankings (OD-04, OD-05, OD-06), Predictions (OD-07), Fixtures & Results (OD-08, OD-09), Private Leagues (OD-10, OD-11, OD-12, OD-13).*
